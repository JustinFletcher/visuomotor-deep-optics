...
def rollout_optomech_policy(model_path=None,
    ...
    if env_vars_path is None:
        ...
        # Make only the non-default kwargs overwrite the args loaded from disk.
    ...
    while len(episodic_returns) < rollout_episodes:
        ...
        # Handle special saving for DASIE environments.
        if (args.env_id == "DASIE-v1") and args.write_env_state_info:
