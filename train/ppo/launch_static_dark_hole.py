...
# from $WORKDIR (the per-user mount point under /p/work), with a
# conservative fallback. Override with VMDO_HPC_WORKDIR if your clone
# lives somewhere else under the work filesystem.
