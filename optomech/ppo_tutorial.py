...
from torchrl.modules import ProbabilisticActor, TanhNormal, ValueOperator, ConvNet
...
# from torchrl.modules import MLP, ConvNet, LSTMModule
...
# mlp_module = TensorDictModule(MLP(num_cells=[64], out_features=2 * env.action_spec.shape[-1],), in_keys=["intermediate"], out_keys=["action"])
...
# mlp_module = TensorDictModule(MLP(num_cells=[64], out_features=1,), in_keys=["intermediate"], out_keys=["state_value"])
